...
public class Designation extends JFrame implements ActionListener,ItemListener
{
	JTextField tf1,tf2;
	JLabel l1,l2,l3;
	JButton b1,b2,b3;
	...
	Designation()
	{
		...
		l1=new JLabel("DESIGNATION EDIT");
		...
		l2=new JLabel("DESIGNATION  ID");
		l2.setBounds(40,140,160,20);
		...
		l3=new JLabel("DESIGNATION NAME");
		l3.setBounds(40,180,180,20);
